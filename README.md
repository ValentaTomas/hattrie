...
[![GitHub Release](https://img.shields.io/github/v/release/valentatomas/fsa3)](https://github.com/valentatomas/fsa3/releases)
[![Go Reference](https://pkg.go.dev/badge/github.com/valentatomas/fsa3.svg)](https://pkg.go.dev/github.com/valentatomas/fsa3)
[![go.mod](https://img.shields.io/github/go-mod/go-version/valentatomas/fsa3)](go.mod)
[![LICENSE](https://img.shields.io/github/license/valentatomas/fsa3)](LICENSE)
[![Build Status](https://img.shields.io/github/workflow/status/valentatomas/fsa3/build)](https://github.com/valentatomas/fsa3/actions?query=workflow%3Abuild+branch%3Amain)
[![Go Report Card](https://goreportcard.com/badge/github.com/valentatomas/fsa3)](https://goreportcard.com/report/github.com/valentatomas/fsa3)
[![Codecov](https://codecov.io/gh/valentatomas/fsa3/branch/main/graph/badge.svg)](https://codecov.io/gh/valentatomas/fsa3)
...
1. Replace all occurrences of `valentatomas/fsa3` to `your_org/repo_name` in all files.
1. Replace all occurrences of `fsa3` to `repo_name` in [Dockerfile](Dockerfile).
